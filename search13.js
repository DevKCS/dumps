...
function fnSetData(pageNum) {
  ...
  const hidCmpNmElement = document.getElementById("hidCmpNm");
  if (hidCmpNmElement) {
    hidCmpNmElement.value = cmpNm || "";
  }
  
  const hidRprsvNmElement = document.getElementById("hidRprsvNm");
  if (hidRprsvNmElement) {
    hidRprsvNmElement.value = rprsvNm || "";
  }
  
  const hidBizRNoElement = document.getElementById("hidBizRNo");
  if (hidBizRNoElement) {
    hidBizRNoElement.value = bizRNo || "";
  }
  
  const hidPgElement = document.getElementById("hidPg");
  if (hidPgElement) {
    hidPgElement.value = pageNo || "";
  }
  
  const hidAreaElement = document.getElementById("hidArea");
  if (hidAreaElement) {
    hidAreaElement.value = strArea || "";
  }
  
  const hidIndstyElment = document.getElementById("hidIndsty");
  if (hidIndstyElment) {
    hidIndstyElment.value = strIndsty || "";
  }
